...
const translations: Record<string, Record<string, string>> = {
  ...
  remain_anonymous_option: { English: 'Remain Anonymous', Yoruba: 'Má Sọ Orúkọ Mi', Igbo: 'Amaghị Aha', Hausa: 'Kasance Ba a San Ka Ba' },
  share_details_option: { English: 'Share My Details', Yoruba: 'Pin Àwọn Àlàyé Mi', Igbo: 'Kọwaa Nkọwa M', Hausa: 'Raba Bayanaina' },
